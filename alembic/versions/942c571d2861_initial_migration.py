...
Revision ID: 942c571d2861
Revises: 
Create Date: 2025-06-24 21:54:20.388549
...
def upgrade() -> None:
    ...
    sa.Column('reset_key', sa.String(length=64), nullable=True),
    ...
    op.create_table('artifact_notification_events',
    sa.Column('event_id', sa.BigInteger(), nullable=False),
    sa.Column('template_id', sa.BigInteger(), nullable=False),
    sa.Column('initiated_by', sa.BigInteger(), nullable=True),
    sa.Column('notification_scope', sa.String(length=20), nullable=True),
    ...
    op.create_index(op.f('ix_artifact_notification_events_event_id'), 'artifact_notification_events', ['event_id'], unique=False)
    ...
    sa.Column('template_id', sa.BigInteger(), nullable=False),
    sa.Column('work_order_type', sa.String(length=50), nullable=False),
    ...
    sa.ForeignKeyConstraint(['created_by'], ['users.user_id'], ),
    sa.ForeignKeyConstraint(['device_id'], ['devices.device_id'], ),
    sa.ForeignKeyConstraint(['template_id'], ['work_order_templates.template_id'], ),
    sa.ForeignKeyConstraint(['work_centre_id'], ['work_centres.work_centre_id'], ),
    ...
    op.create_table('work_order_formdata',
    sa.Column('formdata_id', sa.BigInteger(), nullable=False),
    sa.Column('form_id', sa.BigInteger(), nullable=False),
    sa.Column('session_id', sa.String(length=75), nullable=False),
    ...
    sa.Column('last_updated', sa.DateTime(), nullable=True),
    sa.Column('active', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['form_id'], ['work_order_forms.form_id'], ),
    sa.PrimaryKeyConstraint('formdata_id'),
    sa.UniqueConstraint('session_id')
    )
    op.create_table('work_order_form_attachments',
    sa.Column('attachment_id', sa.BigInteger(), nullable=False),
    sa.Column('formdata_id', sa.BigInteger(), nullable=True),
    ...
    sa.Column('uploaded_at', sa.DateTime(), nullable=True),
    sa.Column('active', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['formdata_id'], ['work_order_formdata.formdata_id'], ),
    sa.ForeignKeyConstraint(['uploaded_by'], ['users.user_id'], ),
    sa.PrimaryKeyConstraint('attachment_id')
    )
    op.create_table('work_order_form_audit',
    sa.Column('audit_id', sa.BigInteger(), nullable=False),
    sa.Column('formdata_id', sa.BigInteger(), nullable=False),
    ...
    op.create_table('work_order_form_sessions',
    sa.Column('session_id', sa.String(length=75), nullable=False),
    sa.Column('formdata_id', sa.BigInteger(), nullable=False),
    sa.Column('agent_id', sa.BigInteger(), nullable=False),
    ...
    op.create_table('work_order_form_steps',
    sa.Column('step_id', sa.BigInteger(), nullable=False),
    sa.Column('formdata_id', sa.BigInteger(), nullable=False),
    sa.Column('form_id', sa.BigInteger(), nullable=False),
    sa.Column('step_number', sa.Integer(), nullable=False),
    sa.Column('step_title', sa.String(length=100), nullable=False),
    sa.Column('status', sa.String(length=20), nullable=True),
    ...
    op.create_table('work_order_form_validation_logs',
    sa.Column('validation_id', sa.BigInteger(), nullable=False),
    sa.Column('formdata_id', sa.BigInteger(), nullable=False),
    sa.Column('step_number', sa.Integer(), nullable=False),
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('work_order_form_validation_logs')
    op.drop_table('work_order_form_steps')
    op.drop_table('work_order_form_sessions')
    op.drop_table('work_order_form_audit')
    op.drop_table('work_order_form_attachments')
    op.drop_table('work_order_formdata')
    ...
    op.drop_index(op.f('ix_artifact_notification_events_event_id'), table_name='artifact_notification_events')
    op.drop_table('artifact_notification_events')
    op.drop_table('users')
